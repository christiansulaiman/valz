...
function updateApp() {
  ...
  if (yesPressed) {
    ...
    app.innerHTML += `<img id="noGif" class="h-[200px]" src="${noGifs[0]}"><h1 class="text-4xl my-4">Bubba will you be my Valentine? I dare you to say no :3</h1><div><button onclick="setYesPressed()" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mr-4" style="font-size:${yesButtonSize}px;">Yes</button><button onclick="handleNoClick()" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" id="noButton">${getNoButtonText()}</button></div>`;
